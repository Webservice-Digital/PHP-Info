...
<style>
	...
	h1{color:#379;margin:0 0 0 -1.6em}
	#gold{color:#c90;cursor:pointer;text-decoration:underline;text-decoration-line:dashed;font-size:.5em;font-style:normal;font-weight:100;vertical-align:super}
	nav{bottom:0;font-size:13px;position:fixed;top:0;z-index:2}
	...
	.filterForm .btn{border:none;color:#fff;padding:.1em;border-radius:.2em;cursor:pointer;font-size:1.2em;line-height:1em;background:rgba(0,68,136,.1)}
	...
	.golden .filterForm .btn{background:rgba(204,153,0,.2)}
